"""Script de extração de /fixtures/events da API-Football (linha do tempo do jogo).

Sem argparse (regra `.cursorrules`). Modo via env var `FIXTURE_EVENTS_MODE`:
...
# scripts/futebol/extract_fixture_events.py → sobe 3 níveis até data-engineering/
