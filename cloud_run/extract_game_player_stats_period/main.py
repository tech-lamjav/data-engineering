...
from extract_game_player_stats_period import main as extract_main


@functions_framework.http
def extract_game_player_stats_period(request):
    """NBA Game Player Stats Per-Period Pipeline"""
    try:
