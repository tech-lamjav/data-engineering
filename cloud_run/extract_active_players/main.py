...
from extract_active_players import main as extract_main


@functions_framework.http
def extract_active_players(request, *args, **kwargs):
    """NBA Active Players Pipeline"""
    try:
