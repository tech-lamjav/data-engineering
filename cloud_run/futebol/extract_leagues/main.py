...
# pra manter o import `from extract_leagues import main` simples.
...
from extract_leagues import main as extract_main


@functions_framework.http
def extract_leagues(request):
    """API-Football /leagues pipeline.
