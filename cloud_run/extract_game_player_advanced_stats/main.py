...
from extract_game_player_advanced_stats import main as extract_main


@functions_framework.http
def extract_game_player_advanced_stats(request):
    """NBA Game Player Advanced Stats Pipeline (passing/tracking)"""
    try:
